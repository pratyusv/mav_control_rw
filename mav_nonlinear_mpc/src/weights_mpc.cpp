...
#include "/home/pratyush/Desktop/rotor_s/catkin_ws/src/mav_control_rw/mav_nonlinear_mpc/include/mav_nonlinear_mpc/params.hpp"
// #include <params.hpp>
...
int main(int argc, char** argv)
{
  ...
  while (nh.ok()) 
  {
    ...
    // for(int i = 0; i < np.mean.rows(); i++){
    //   std::cout<<np.mean(i)<<std::endl;
    // }
    // std::cout<< std::endl;

    // std::cout<<"Std "<<std::endl;
    // for(int i = 0; i < np.std.rows(); i++){
    //   std::cout<<np.std(i)<<std::endl;
    // }
    ...
    // std::cout<<"Mean  "<<np.mean<<std::endl;
    // std::cout<<"Std   "<<np.std<<std::endl;
    ...
    // std::cout<<op2.rows() <<" | "<<op2.cols() << std::endl;
    ...
    // std::cout<<op3.rows() <<" | "<<op3.cols() << std::endl;
